...
public class Main {
    ...
    public static void buyTermInsurancePolicy() 
    	   {
    	       ...
    	       termInsuranceDO termInsurancePolicy = new termInsuranceDO(partySeq,String.valueOf(SequenceGenerator.getInstance().CurrentPolicySequence), premiumAmt, sumAssured);
    	       ...
    	       System.out.println("Term Insurance Policy added successfully.Term Health Insurance Sequence is " +policySeq);
    	   }
    public static void buyTermHealthInsurancePolicy() 
	   {
	       ...
	       termHealthInsuranceDO termHealthInsurancePolicy = new termHealthInsuranceDO(partySeq,String.valueOf(SequenceGenerator.getInstance().CurrentPolicySequence), premiumAmt, sumAssured,healthCover);
    ...
    public static void searchPolicy()
    {
    	System.out.print("Enter Party Sequence: ");
	       ...
	       for(Map.Entry<String,basePolicyDO> entry : policies.entrySet())
	       {
	       ...
	       {
	    	   termHealthInsuranceDO termhealthinsurance = (termHealthInsuranceDO) policy;
